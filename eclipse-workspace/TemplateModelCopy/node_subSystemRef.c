...
static void node_subSystemRef_initMessageServices(void) {
	ET_MSC_LOGGER_SYNC_ENTRY("node_subSystemRef", "initMessageServices")
	{
		...
		etMessageService_init(
			...
			99,
			interval,
			MsgDispatcher_AllThread_receiveMessage,
			EXECMODE_MIXED);

		etMessageService_init_kkr(
...
static void node_subSystemRef_startMessageServices(void) {
	...
	etMessageService_start_kkr(&msgService_AirflowThread);
	etMessageService_start_kkr(&msgService_ThrottleThread);
	etMessageService_start_kkr(&msgService_PedalThread);
	etMessageService_start_kkr(&msgService_IgniactThread);
	etMessageService_start_kkr(&msgService_InjectactThread);
	etMessageService_start_kkr(&msgService_ThrottleactThread);
	etMessageService_start_kkr(&msgService_IgnitionsysThread);
	etMessageService_start_kkr(&msgService_FuelingsysThread);
	etMessageService_start_kkr(&msgService_AirsysThread);
	etMessageService_start_kkr(&msgService_PedaldiagThread);
